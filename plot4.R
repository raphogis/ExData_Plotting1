...
# Drawing plots
# Plot 1
with(subDataset, plot(Time, Global_active_power, type = "l", xlab = "", 
                      ylab = "Global Active Power"))
# Plot 2
with(subDataset, plot(Time, Voltage, type = "l", xlab = "datatime", 
                      ylab = "Voltage"))
# Plot 3
...
# Plot 4
with(subDataset, plot(Time, Global_reactive_power, type = "l", xlab = "datetime", 
